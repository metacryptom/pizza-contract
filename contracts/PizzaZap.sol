...
interface IPizzaSwapMining {
    function withdraw(uint256 _pid) external ;
}

// File: Zap.sol

contract PIZZAZap is Ownable, IPIZZAZap ,ReentrancyGuard{
    ...
    function withdrawSwapMining(IPizzaSwapMining swapIns,uint256 pid) external onlyOwner {
